...
SauceDemo ([https://www.saucedemo.com/](https://www.saucedemo.com/)) を対象にした Playwright E2E テストのサンプルです。  
...
以下のように「/playwright-code」でSKILLを利用することで、VS Code 内ブラウザを使った操作からテストコードを生成できる。
...
- 外部の codegen 実行は必須ではなく、内部ブラウザでの実操作を一次情報として扱う。
